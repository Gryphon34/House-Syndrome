...
{
    public class CRTAPERTURE_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        CRTAPERTURE_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/CRT_APERTURE");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new CRTAPERTURE_Pass(material);
        ...
        public class CRTAPERTURE_Pass : ScriptableRenderPass
        {
            ...
            public CRTAPERTURE_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                material.SetFloat("HaloStrength", volumeComponent.HaloStrength.value);
                material.SetFloat("BlendAmount", volumeComponent.Fade.value);
                material.SetFloat("GlowDiffusion", volumeComponent.GlowDiffusion.value);
                material.SetFloat("TriadColorCount", volumeComponent.MaskColorCount.value);
                material.SetFloat("MaskStrength", volumeComponent.MaskStrength.value);
                material.SetFloat("InputGamma", volumeComponent.InputGamma.value);
                material.SetFloat("OutputGamma", volumeComponent.OutputGamma.value);
                material.SetFloat("OutputBrightness", volumeComponent.OutputBrightness.value);
