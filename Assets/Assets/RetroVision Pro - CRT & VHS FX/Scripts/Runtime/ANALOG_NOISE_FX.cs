...
{
    public class ANALOG_NOISE_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        ANALOG_NOISE_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/ANALOG_NOISE");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new ANALOG_NOISE_Pass(material);
        ...
        {
            ANALOG_NOISE myVolume = VolumeManager.instance.stack?.GetComponent<ANALOG_NOISE>();
        ...
        public class ANALOG_NOISE_Pass : ScriptableRenderPass
        {
            ...
            public ANALOG_NOISE_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<ANALOG_NOISE>();
                ...
                material.SetFloat("TimeX", TimeX);
                material.SetFloat("_Fade", volumeComponent.fade.value);
                if (volumeComponent.texture.value != null)
                    material.SetTexture("_Pattern", volumeComponent.texture.value);
                material.SetFloat("barHeight", volumeComponent.barWidth.value);
                material.SetFloat("barSpeed", volumeComponent.barSpeed.value);
                material.SetFloat("cut", volumeComponent.CutOff.value);
                material.SetFloat("edgeCutOff", volumeComponent.edgeCutOff.value);
                material.SetFloat("angle", volumeComponent.textureAngle.value);
                material.SetFloat("tileX", volumeComponent.tile.value.x);
                material.SetFloat("tileY", volumeComponent.tile.value.y);
                material.SetFloat("horizontal", volumeComponent.Horizontal.value ? 1 : 0);
                if (!volumeComponent.staticNoise.value)
                {
                    material.SetFloat("_OffsetNoiseX", UnityEngine.Random.Range(0f, 0.6f));
                    material.SetFloat("_OffsetNoiseY", UnityEngine.Random.Range(0f, 0.6f));
                }
