...
{
    public class RETROSCALE_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        RETROSCALE_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/RETROSCALE");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new RETROSCALE_Pass(material);
        ...
        {
            RETROSCALE myVolume = VolumeManager.instance.stack?.GetComponent<RETROSCALE>();
        ...
        public class RETROSCALE_Pass : ScriptableRenderPass
        {
            ...
            public RETROSCALE_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<RETROSCALE>();
                ...
                material.SetFloat("_Scale", volumeComponent.RenderScale.value);
                material.SetFloat("_Keep43", volumeComponent.CRT43Mode.value ? 1 : 0);
                material.SetFloat("_Chroma", volumeComponent.ChromaCompression.value);
