...
{
    public class NTSCCODEC_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        NTSCCODEC_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/NTSCCodec");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new NTSCCODEC_Pass(material);
        ...
        {
            NTSCCODEC myVolume = VolumeManager.instance.stack?.GetComponent<NTSCCODEC>();
        ...
        public class NTSCCODEC_Pass : ScriptableRenderPass
        {
            ...
            public NTSCCODEC_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<NTSCCODEC>();
                ...
                material.SetFloat("fade", volumeComponent.Amount.value);
                material.SetFloat("val1", volumeComponent.LineScanTimeOffset.value);
                float ra = Random.Range(volumeComponent.LinePhaseRandomness.value.x, volumeComponent.LinePhaseRandomness.value.y);
                material.SetFloat("_RandomizeVal", ra);
                material.SetFloat("_BrightnessY", volumeComponent.LumaGain.value);
                material.SetFloat("_ChromaSat", volumeComponent.ChromaSaturation.value);
                material.SetFloat("_YBlur", volumeComponent.LumaBlurWidth.value);
