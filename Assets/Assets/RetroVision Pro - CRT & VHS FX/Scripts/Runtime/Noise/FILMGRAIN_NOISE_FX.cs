...
{
    public class FILMGRAIN_NOISE_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        FILMGRAIN_NOISE_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/FilmGrainShader");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new FILMGRAIN_NOISE_Pass(material);
        ...
        {
            FILMGRAIN myVolume = VolumeManager.instance.stack?.GetComponent<FILMGRAIN>();
        ...
        public class FILMGRAIN_NOISE_Pass : ScriptableRenderPass
        {
            ...
            public FILMGRAIN_NOISE_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<FILMGRAIN>();
                ...
                material.SetFloat("filmGrainAmount", volumeComponent.GranularityAmount.value);
