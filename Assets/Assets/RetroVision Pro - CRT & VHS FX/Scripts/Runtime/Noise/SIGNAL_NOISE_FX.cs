...
{
    public class SIGNAL_NOISE_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        SIGNAL_NOISE_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/SignalNoiseShader");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new SIGNAL_NOISE_Pass(material);
        ...
        {
            SIGNAL_NOISE myVolume = VolumeManager.instance.stack?.GetComponent<SIGNAL_NOISE>();
        ...
        public class SIGNAL_NOISE_Pass : ScriptableRenderPass
        {
            ...
            public SIGNAL_NOISE_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<SIGNAL_NOISE>();
                ...
                material.SetFloat("signalNoisePower", volumeComponent.SignalNoisePower.value);
                material.SetFloat("signalNoiseAmount", volumeComponent.SignalNoiseAmount.value);
