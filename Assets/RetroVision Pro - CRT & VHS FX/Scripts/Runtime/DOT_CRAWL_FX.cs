...
{
    public class DOT_CRAWL_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        DOT_CRAWL_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/DotCrawl");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new DOT_CRAWL_Pass(material);
        ...
        {
            DOT_CRAWL myVolume = VolumeManager.instance.stack?.GetComponent<DOT_CRAWL>();
        ...
        public class DOT_CRAWL_Pass : ScriptableRenderPass
        {
            ...
            public DOT_CRAWL_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<DOT_CRAWL>();
                ...
                material.SetFloat("_DotOffsetPx", volumeComponent.DotOffsetPx.value);
                material.SetFloat("_DotFeatherPx", volumeComponent.DotFeatherPx.value);

                material.SetFloat("_EdgeSensitivity", volumeComponent.EdgeSensitivity.value);
                material.SetFloat("_DotSize", volumeComponent.DotSize.value);

                material.SetFloat("_CrawlSpeed", volumeComponent.AnimationSpeed.value);
                material.SetInt("_EdgeMode", volumeComponent.EdgeDetectionMode.value);

                material.SetFloat("_BleedPower", volumeComponent._BleedPower.value);
