...
{
    public class VHS_TAPE_REWIND_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        VHS_TAPE_REWIND_Pass RetroVision_RenderPass;
        ...
        public override void Create()
        {
            ...
            RetroVision_RenderPass = new VHS_TAPE_REWIND_Pass(material);
        ...
        {
            VHS_TAPE_REWIND myVolume = VolumeManager.instance.stack?.GetComponent<VHS_TAPE_REWIND>();
        ...
        public class VHS_TAPE_REWIND_Pass : ScriptableRenderPass
        {
            ...
            public VHS_TAPE_REWIND_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<VHS_TAPE_REWIND>();
                ...
                material.SetFloat("RegionHeight", volumeComponent.RegionHeight.value);
                material.SetFloat("RegionFeather", volumeComponent.RegionFeather.value);
                material.SetFloat("AnimSpeed", volumeComponent.AnimSpeed.value);
                material.SetFloat("AnimMode", ((int)volumeComponent.AnimationMode.value));
