...
{
    public class VCRGHOSTING_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        VCRGHOSTING_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/VCRGhosting");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new VCRGHOSTING_Pass(material);
        ...
        {
            VCRGHOSTING myVolume = VolumeManager.instance.stack?.GetComponent<VCRGHOSTING>();
        ...
        public class VCRGHOSTING_Pass : ScriptableRenderPass
        {
            ...
            public VCRGHOSTING_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<VCRGHOSTING>();
                ...
                material.SetFloat("_BlurGhostPx", volumeComponent._BlurGhostPx.value);
                material.SetFloat("_GhostOffset", volumeComponent.GhostOffset.value);
                material.SetFloat("_Tilt", volumeComponent._Tilt.value);
