...
{
    public class LINE_NOISE_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        LINE_NOISE_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/LineNoiseShader");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new LINE_NOISE_Pass(material);
        ...
        {
            LINE_NOISE myVolume = VolumeManager.instance.stack?.GetComponent<LINE_NOISE>();
        ...
        public class LINE_NOISE_Pass : ScriptableRenderPass
        {
            ...
            public LINE_NOISE_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<LINE_NOISE>();
                ...
                material.SetFloat("time_", _time);

                material.SetFloat("lineNoiseFade", volumeComponent.LineNoiseFade.value);
                material.SetFloat("lineNoiseAmount", 1f - volumeComponent.LineNoiseAmount.value);
                material.SetFloat("lineNoiseSpeed", volumeComponent.LineNoiseSpeed.value);
