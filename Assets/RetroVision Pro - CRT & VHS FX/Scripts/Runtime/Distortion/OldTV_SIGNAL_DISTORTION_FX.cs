...
{
    public class OldTV_SIGNAL_DISTORTION_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        OldTV_SIGNAL_DISTORTION_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/OldTV_SignalDistortion");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new OldTV_SIGNAL_DISTORTION_Pass(material);
        ...
        {
            OldTV_SIGNAL_DISTORTION myVolume = VolumeManager.instance.stack?.GetComponent<OldTV_SIGNAL_DISTORTION>();
        ...
        public class OldTV_SIGNAL_DISTORTION_Pass : ScriptableRenderPass
        {
            ...
            public OldTV_SIGNAL_DISTORTION_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<OldTV_SIGNAL_DISTORTION>();
                ...
                material.SetFloat("_Blend", volumeComponent.Amount.value);
                material.SetFloat("_PlaySpeed", volumeComponent.Speed.value);
                material.SetFloat("_LineJitterPx", volumeComponent.LineJitterAmount.value);
                material.SetFloat("_ChunkJitterPx", volumeComponent.ChunkJitterAmount.value);
                material.SetFloat("_ChunksPerRow", volumeComponent.ChunkJitterSegments.value);
                material.SetFloat("_SineRipplePx", volumeComponent.SineRippleAmount.value);
                material.SetFloat("_SineRippleSpeed", volumeComponent.SineRippleSpeed.value);
