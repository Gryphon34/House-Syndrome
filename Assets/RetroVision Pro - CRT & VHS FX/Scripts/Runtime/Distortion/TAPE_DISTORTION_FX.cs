...
{
    public class TAPE_DISTORTION_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        TAPE_DISTORTION_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/TapeDistortionShader");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new TAPE_DISTORTION_Pass(material);
        ...
        {
            TAPE_DISTORTION myVolume = VolumeManager.instance.stack?.GetComponent<TAPE_DISTORTION>();
        ...
        public class TAPE_DISTORTION_Pass : ScriptableRenderPass
        {
            ...
            public TAPE_DISTORTION_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<TAPE_DISTORTION>();
                ...
                material.SetFloat("TapeFreq", volumeComponent.TapeFrequency.value);
                material.SetFloat("TapeWidth", volumeComponent.TapeWidth.value);
                material.SetFloat("TapeFeather", volumeComponent.TapeFeather.value);
