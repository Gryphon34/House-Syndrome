...
{
    public class VHS_JITTER_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        VHS_JITTER_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/Distortion/VHS_JITTER");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new VHS_JITTER_Pass(material);
        ...
        {
            VHS_JITTER myVolume = VolumeManager.instance.stack?.GetComponent<VHS_JITTER>();
        ...
        public class VHS_JITTER_Pass : ScriptableRenderPass
        {
            ...
            public VHS_JITTER_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<VHS_JITTER>();
                ...
                material.SetFloat("jitterHAmount", volumeComponent.jitterHorizontalAmount.value);

                material.SetFloat("jitterVAmount", volumeComponent.jitterVerticalAmount.value);
                material.SetFloat("jitterVSpeed", volumeComponent.jitterVerticalSpeed.value);
                material.SetFloat("jitterHSpeed", volumeComponent.jitterHorizontalSpeed.value);
