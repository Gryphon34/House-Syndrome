...
{
    public class BLEED2PHASE_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        BLEED2PHASE_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/Bleed2PHASE");
            if (m_Shader == null)
            {
            ...
            RetroVision_RenderPass = new BLEED2PHASE_Pass(material);
        ...
        {
            BLEED_2PHASE myVolume = VolumeManager.instance.stack?.GetComponent<BLEED_2PHASE>();
        ...
        public class BLEED2PHASE_Pass : ScriptableRenderPass
        {
            ...
            public BLEED2PHASE_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<BLEED_2PHASE>();
