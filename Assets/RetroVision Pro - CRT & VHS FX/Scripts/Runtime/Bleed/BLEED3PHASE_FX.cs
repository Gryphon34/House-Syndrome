...
{
    public class BLEED3PHASE_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        BLEED3PHASE_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/Bleed3PHASE");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new BLEED3PHASE_Pass(material);
        ...
        {
            BLEED_3PHASE myVolume = VolumeManager.instance.stack?.GetComponent<BLEED_3PHASE>();
        ...
        public class BLEED3PHASE_Pass : ScriptableRenderPass
        {
            ...
            public BLEED3PHASE_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<BLEED_3PHASE>();
