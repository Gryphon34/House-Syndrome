...
{
    public class BLEEDOLD3PHASE_FX : ScriptableRendererFeature
    {
        [SerializeField]
        private Shader m_Shader;
        private Material material;
        BLEEDOLD3PHASE_Pass RetroVision_RenderPass;
        public RenderPassEvent Event = RenderPassEvent.BeforeRenderingPostProcessing;

        public override void Create()
        {
            m_Shader = Shader.Find("RetroVisionPro/CRT&VHSFX/BleedOld3Phase");
            if (m_Shader == null)
            {
                return;
            }
            material = new Material(m_Shader);
            RetroVision_RenderPass = new BLEEDOLD3PHASE_Pass(material);
        ...
        {
            BLEED_OLD3PHASE myVolume = VolumeManager.instance.stack?.GetComponent<BLEED_OLD3PHASE>();
        ...
        public class BLEEDOLD3PHASE_Pass : ScriptableRenderPass
        {
            ...
            public BLEEDOLD3PHASE_Pass(Material material)
            {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                var volumeComponent = VolumeManager.instance.stack.GetComponent<BLEED_OLD3PHASE>();
                ...
                material.SetFloat("M_Bleed_Amount", volumeComponent.BleedAmount.value);
